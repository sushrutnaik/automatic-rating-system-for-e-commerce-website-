...
<form  style="border:1px solid #ccc" name="myForm" onsubmit="return (validate());" method="post" action="data.php">
  <div class="container">
    <h1>Sign Up</h1>
    ...
    <div class="clearfix">
      <button type="button" class="cancelbtn" onclick="window.location.href='frontpage.php'">Cancel</button>
